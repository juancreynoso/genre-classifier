...
def load_data(include_folklore=False, n_folklore_train=None):
    """
    Carga datos de GTZAN y opcionalmente folklore
    
    Args:
        include_folklore: Si True, incluye folklore en entrenamiento
        n_folklore_train: Cuantas canciones de folklore usar para train
...
def create_cnn_model(input_shape, num_classes):
    """
    Crea una CNN simple para clasificacion de generos
...
# Cargar resultado de SVM (si existe)
try:
    ...
    if accuracy > svm_accuracy:
        ...
        print("\nSVM sigue siendo competitivo")
        
except:
    print("\nNo se encontraron resultados de SVM para comparar")
...
print(f"\n1. CNN obtuvo {accuracy:.1%} de accuracy")
print("2. Ventajas de CNN:")
print("   - Aprende features automaticamente")
print("   - Captura estructura temporal")
print("   - Jerárquica (frecuencias -> acordes -> patterns)")
print("\n3. Desventajas de CNN:")
print("   - Requiere mas datos (idealmente 500+ por clase)")
print("   - Mas lento de entrenar")
print("   - Menos interpretable (caja negra)")

print("\n" + "="*60)
print("Experimento CNN completo")
print("="*60)